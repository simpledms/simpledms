...
func (_q *AttributeQuery) QuerySpace() *SpaceQuery {
...
func (_q *AttributeQuery) QueryDocumentType() *DocumentTypeQuery {
...
func (_q *AttributeQuery) QueryTag() *TagQuery {
...
func (_q *AttributeQuery) QueryProperty() *PropertyQuery {
...
func (_q *AttributeQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AttributeQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AttributeQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AttributeQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AttributeQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *AttributeQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AttributeQuery) WithSpace(opts ...func(*SpaceQuery)) *AttributeQuery {
	query := (&SpaceClient{config: _q.config}).Query()
...
func (_q *AttributeQuery) WithDocumentType(opts ...func(*DocumentTypeQuery)) *AttributeQuery {
	query := (&DocumentTypeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AttributeQuery) WithTag(opts ...func(*TagQuery)) *AttributeQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AttributeQuery) WithProperty(opts ...func(*PropertyQuery)) *AttributeQuery {
	query := (&PropertyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AttributeQuery) prepareQuery(ctx context.Context) error {
	...
	if err := attribute.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *AttributeQuery) loadSpace(ctx context.Context, query *SpaceQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *Space)) error {
...
func (_q *AttributeQuery) loadDocumentType(ctx context.Context, query *DocumentTypeQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *DocumentType)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Attribute)
	for i := range nodes {
...
func (_q *AttributeQuery) loadTag(ctx context.Context, query *TagQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *Tag)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Attribute)
	for i := range nodes {
		fk := nodes[i].TagID
...
func (_q *AttributeQuery) loadProperty(ctx context.Context, query *PropertyQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *Property)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Attribute)
	for i := range nodes {
...
func (_q *AttributeQuery) Modify(modifiers ...func(s *sql.Selector)) *AttributeSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *AttributeSelect) Modify(modifiers ...func(s *sql.Selector)) *AttributeSelect {
