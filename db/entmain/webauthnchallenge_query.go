...
func (_q *WebAuthnChallengeQuery) QueryAccount() *AccountQuery {
...
func (_q *WebAuthnChallengeQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *WebAuthnChallengeQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *WebAuthnChallengeQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *WebAuthnChallengeQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *WebAuthnChallengeQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *WebAuthnChallengeQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *WebAuthnChallengeQuery) WithAccount(opts ...func(*AccountQuery)) *WebAuthnChallengeQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
//		GroupBy(webauthnchallenge.FieldChallengeID).
...
//
//	client.WebAuthnChallenge.Query().
//		Select(webauthnchallenge.FieldChallengeID).
//		Scan(ctx, &v)
...
func (_q *WebAuthnChallengeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*WebAuthnChallenge, error) {
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *WebAuthnChallenge, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *WebAuthnChallengeQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*WebAuthnChallenge, init func(*WebAuthnChallenge), assign func(*WebAuthnChallenge, *Account)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*WebAuthnChallenge)
	for i := range nodes {
...
func (_q *WebAuthnChallengeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(webauthnchallenge.Table, webauthnchallenge.Columns, sqlgraph.NewFieldSpec(webauthnchallenge.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccount != nil {
			_spec.Node.AddColumnOnce(webauthnchallenge.FieldAccountID)
		}
	}
...
func (_q *WebAuthnChallengeQuery) Modify(modifiers ...func(s *sql.Selector)) *WebAuthnChallengeSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *WebAuthnChallengeSelect) Modify(modifiers ...func(s *sql.Selector)) *WebAuthnChallengeSelect {
