...
A video of the app where @marcobeierer guides you through the first steps in SimpleDMS is [available on YouTube](https://www.youtube.com/watch?v=TP2TXxgk9z8).

*The video is currently only available in German, but autogenerated English subs are available.*

<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/TP2TXxgk9z8?si=m49XzJbZS5kYRv-C" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
