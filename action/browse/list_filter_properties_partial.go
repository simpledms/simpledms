...
type ListFilterPropertiesPartialData struct {
	CurrentDirID   string
	DocumentTypeID int64 // can be 0
}

// TODO rename
type ListFilterPropertiesPartial struct {
	infra   *common.Infra
	actions *Actions
	*actionx.Config
}

func NewListFilterPropertiesPartial(infra *common.Infra, actions *Actions) *ListFilterPropertiesPartial {
	return &ListFilterPropertiesPartial{
		infra:   infra,
		actions: actions,
...
func (qq *ListFilterPropertiesPartial) Data(currentDirID string, documentTypeID int64) *ListFilterPropertiesPartialData {
	return &ListFilterPropertiesPartialData{
...
func (qq *ListFilterPropertiesPartial) Widget(
	ctx ctxx.Context,
	data *ListFilterPropertiesPartialData,
...
func (qq *ListFilterPropertiesPartial) id() string {
...
func (qq *ListFilterPropertiesPartial) createTextFilterWithChips(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
...
func (qq *ListFilterPropertiesPartial) createNumberFilterWithChips(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	currentFilters map[string]string,
...
func (qq *ListFilterPropertiesPartial) createTextFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
...
func (qq *ListFilterPropertiesPartial) createNumberFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
...
func (qq *ListFilterPropertiesPartial) createNumberRangeFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
...
func (qq *ListFilterPropertiesPartial) createDateFilterWithChips(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	currentFilters map[string]string,
...
func (qq *ListFilterPropertiesPartial) createDateFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
...
func (qq *ListFilterPropertiesPartial) createDateRangeFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
...
func (qq *ListFilterPropertiesPartial) createCheckboxFilter(
	ctx ctxx.Context,
	currentDirID string,
	propertyID int64,
	filterType string,
