...
import (
	...
	"github.com/simpledms/simpledms/app/simpledms/entmain/hook"
	"github.com/simpledms/simpledms/app/simpledms/entmain/intercept"
	"github.com/simpledms/simpledms/app/simpledms/entx"
)

// IMPORTANT
// shares most code with enttenant.SoftDeleteMixin; cannot merge because hook and intercept dependencies
...
func NewSoftDeleteMixin(entityType any) SoftDeleteMixin {
	return SoftDeleteMixin{
		SoftDeleteMixin: entx.NewUnsafeSoftDeleteMixin(entityType, Account.Type),
	}
}
