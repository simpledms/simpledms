...
type File struct {
	...
	// Tags         []*tagging.Tag
	// Versions     []*File
	nilableCurrentVersion *storedfilemodel.StoredFile
	nilableParent         *File
}
...
func (qq *File) CurrentVersion(ctx context.Context) *storedfilemodel.StoredFile {
	...
	qq.nilableCurrentVersion = storedfilemodel.NewStoredFile(version.Edges.StoredFile) // TODO inject factory into ctx?
