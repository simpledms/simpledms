...
func (_q *AccountQuery) QueryTenants() *TenantQuery {
...
func (_q *AccountQuery) QueryReceivedMails() *MailQuery {
	query := (&MailClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AccountQuery) QueryTemporaryFiles() *TemporaryFileQuery {
	query := (&TemporaryFileClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AccountQuery) QueryTenantAssignment() *TenantAccountAssignmentQuery {
...
func (_q *AccountQuery) WithTenants(opts ...func(*TenantQuery)) *AccountQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *AccountQuery) WithReceivedMails(opts ...func(*MailQuery)) *AccountQuery {
	query := (&MailClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withReceivedMails = query
	return _q
}
...
func (_q *AccountQuery) WithTemporaryFiles(opts ...func(*TemporaryFileQuery)) *AccountQuery {
	query := (&TemporaryFileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withTemporaryFiles = query
	return _q
}
...
func (_q *AccountQuery) WithTenantAssignment(opts ...func(*TenantAccountAssignmentQuery)) *AccountQuery {
	query := (&TenantAccountAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withTenantAssignment = query
	return _q
}
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withReceivedMails; query != nil {
		if err := _q.loadReceivedMails(ctx, query, nodes,
	...
	if query := _q.withTemporaryFiles; query != nil {
		if err := _q.loadTemporaryFiles(ctx, query, nodes,
	...
	if query := _q.withTenantAssignment; query != nil {
		if err := _q.loadTenantAssignment(ctx, query, nodes,
...
func (_q *AccountQuery) loadTenants(ctx context.Context, query *TenantQuery, nodes []*Account, init func(*Account), assign func(*Account, *Tenant)) error {
...
func (_q *AccountQuery) loadReceivedMails(ctx context.Context, query *MailQuery, nodes []*Account, init func(*Account), assign func(*Account, *Mail)) error {
...
func (_q *AccountQuery) loadTemporaryFiles(ctx context.Context, query *TemporaryFileQuery, nodes []*Account, init func(*Account), assign func(*Account, *TemporaryFile)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Account)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *AccountQuery) loadTenantAssignment(ctx context.Context, query *TenantAccountAssignmentQuery, nodes []*Account, init func(*Account), assign func(*Account, *TenantAccountAssignment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Account)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
