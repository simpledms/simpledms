...
func (_q *UserQuery) QuerySpaces() *SpaceQuery {
...
func (_q *UserQuery) QuerySpaceAssignment() *SpaceUserAssignmentQuery {
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withSpaceAssignment: _q.withSpaceAssignment.Clone(),
...
func (_q *UserQuery) WithSpaces(opts ...func(*SpaceQuery)) *UserQuery {
	query := (&SpaceClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithSpaceAssignment(opts ...func(*SpaceUserAssignmentQuery)) *UserQuery {
	query := (&SpaceUserAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSpaceAssignment = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withSpaceAssignment; query != nil {
		if err := _q.loadSpaceAssignment(ctx, query, nodes,
...
func (_q *UserQuery) loadSpaces(ctx context.Context, query *SpaceQuery, nodes []*User, init func(*User), assign func(*User, *Space)) error {
...
func (_q *UserQuery) loadSpaceAssignment(ctx context.Context, query *SpaceUserAssignmentQuery, nodes []*User, init func(*User), assign func(*User, *SpaceUserAssignment)) error {
