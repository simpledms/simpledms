...
func (_q *TagQuery) QuerySpace() *SpaceQuery {
...
func (_q *TagQuery) QueryGroup() *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TagQuery) QuerySuperTags() *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TagQuery) QuerySubTags() *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TagQuery) QueryFiles() *FileQuery {
...
func (_q *TagQuery) QueryTagAssignment() *TagAssignmentQuery {
...
func (_q *TagQuery) Clone() *TagQuery {
	...
	return &TagQuery{
		...
		withSuperTags:     _q.withSuperTags.Clone(),
		withSubTags:       _q.withSubTags.Clone(),
...
func (_q *TagQuery) WithSpace(opts ...func(*SpaceQuery)) *TagQuery {
	query := (&SpaceClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithGroup(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) WithSuperTags(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSuperTags = query
	return _q
}
...
func (_q *TagQuery) WithSubTags(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withSubTags = query
	return _q
}

// WithFiles tells the query-builder to eager-load the nodes that are connected to
// the "files" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TagQuery) WithFiles(opts ...func(*FileQuery)) *TagQuery {
	query := (&FileClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) WithTagAssignment(opts ...func(*TagAssignmentQuery)) *TagQuery {
	query := (&TagAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withSuperTags; query != nil {
		if err := _q.loadSuperTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.SuperTags = []*Tag{} },
			func(n *Tag, e *Tag) { n.Edges.SuperTags = append(n.Edges.SuperTags, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSubTags; query != nil {
		if err := _q.loadSubTags(ctx, query, nodes,
...
func (_q *TagQuery) loadSpace(ctx context.Context, query *SpaceQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Space)) error {
...
func (_q *TagQuery) loadGroup(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Tag)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (_q *TagQuery) loadSuperTags(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
...
func (_q *TagQuery) loadSubTags(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Tag)
	nids := make(map[int64]map[*Tag]struct{})
	for i, node := range nodes {
...
func (_q *TagQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *File)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Tag)
	nids := make(map[int64]map[*Tag]struct{})
	for i, node := range nodes {
...
func (_q *TagQuery) loadTagAssignment(ctx context.Context, query *TagAssignmentQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *TagAssignment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Tag)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
