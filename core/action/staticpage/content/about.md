...
SimpleDMS is an Open Source project by Marco Beierer. The official websites are:

- [simpledms.eu](https://simpledms.eu)
- [simpledms.ch](https://simpledms.ch)
- [marcobeierer.com](https://www.marcobeierer.com)
- [marcobeierer.ch](https://www.marcobeierer.ch)

The project is hosted on GitHub. You find the repository with the source code at:

- [https://github.com/simpledms/simpledms](https://github.com/simpledms/simpledms)

If you got your copy from someone else or using a hosted version by another provider, the vendor must provide you a list with all modifications and a copy of the modified source code.
