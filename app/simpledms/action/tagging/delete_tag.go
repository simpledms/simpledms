...
func NewDeleteTag(infra *common.Infra, actions *Actions) *DeleteTag {
...
//
//	consistent
func (qq *DeleteTag) Data(tagID int64) *DeleteTagData {
	return &DeleteTagData{
		TagID: tagID,
		// FileID: fileID,
	}
}

func (qq *DeleteTag) Handler(rw httpx.ResponseWriter, req *httpx.Request, ctx ctxx.Context) error {
	data, err := autil.FormData[DeleteTagData](rw, req, ctx)
	if err != nil {
		return err
	}
