...
type TagQuery struct {
	...
	withGroup         *TagQuery
	withSuperTags     *TagQuery
	withSubTags       *TagQuery
	withFiles         *FileQuery
...
func (tq *TagQuery) QuerySpace() *SpaceQuery {
	query := (&SpaceClient{config: tq.config}).Query()
...
func (tq *TagQuery) QueryGroup() *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
...
// QuerySuperTags chains the current query on the "super_tags" edge.
func (tq *TagQuery) QuerySuperTags() *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
...
// QuerySubTags chains the current query on the "sub_tags" edge.
func (tq *TagQuery) QuerySubTags() *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (tq *TagQuery) QueryTagAssignment() *TagAssignmentQuery {
	query := (&TagAssignmentClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TagQuery) Clone() *TagQuery {
	...
	return &TagQuery{
		...
		withSpace:         tq.withSpace.Clone(),
		withChildren:      tq.withChildren.Clone(),
		withGroup:         tq.withGroup.Clone(),
		withSuperTags:     tq.withSuperTags.Clone(),
		withSubTags:       tq.withSubTags.Clone(),
		withFiles:         tq.withFiles.Clone(),
		withTagAssignment: tq.withTagAssignment.Clone(),
...
func (tq *TagQuery) WithSpace(opts ...func(*SpaceQuery)) *TagQuery {
	query := (&SpaceClient{config: tq.config}).Query()
...
func (tq *TagQuery) WithGroup(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithSuperTags tells the query-builder to eager-load the nodes that are connected to
// the "super_tags" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TagQuery) WithSuperTags(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withSuperTags = query
	return tq
}

// WithSubTags tells the query-builder to eager-load the nodes that are connected to
// the "sub_tags" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TagQuery) WithSubTags(opts ...func(*TagQuery)) *TagQuery {
	query := (&TagClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withSubTags = query
	return tq
}
...
func (tq *TagQuery) WithTagAssignment(opts ...func(*TagAssignmentQuery)) *TagQuery {
	query := (&TagAssignmentClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withTagAssignment = query
	return tq
}
...
func (tq *TagQuery) prepareQuery(ctx context.Context) error {
	...
	if tag.Policy == nil {
		return errors.New("enttenant: uninitialized tag.Policy (forgotten import enttenant/runtime?)")
	}
	if err := tag.Policy.EvalQuery(ctx, tq); err != nil {
		return err
	}
	return nil
}
...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	var (
		...
		loadedTypes = [7]bool{
			...
			tq.withChildren != nil,
			tq.withGroup != nil,
			tq.withSuperTags != nil,
			tq.withSubTags != nil,
			tq.withFiles != nil,
			tq.withTagAssignment != nil,
		}
	)
	...
	if query := tq.withSpace; query != nil {
		if err := tq.loadSpace(ctx, query, nodes, nil,
			func(n *Tag, e *Space) { n.Edges.Space = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := tq.withGroup; query != nil {
		if err := tq.loadGroup(ctx, query, nodes, nil,
			func(n *Tag, e *Tag) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withSuperTags; query != nil {
		if err := tq.loadSuperTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.SuperTags = []*Tag{} },
			func(n *Tag, e *Tag) { n.Edges.SuperTags = append(n.Edges.SuperTags, e) }); err != nil {
			return nil, err
		}
	}
	if query := tq.withSubTags; query != nil {
		if err := tq.loadSubTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.SubTags = []*Tag{} },
			func(n *Tag, e *Tag) { n.Edges.SubTags = append(n.Edges.SubTags, e) }); err != nil {
			return nil, err
		}
	}
	if query := tq.withFiles; query != nil {
		if err := tq.loadFiles(ctx, query, nodes,
			func(n *Tag) { n.Edges.Files = []*File{} },
			func(n *Tag, e *File) { n.Edges.Files = append(n.Edges.Files, e) }); err != nil {
			return nil, err
		}
	}
	if query := tq.withTagAssignment; query != nil {
		if err := tq.loadTagAssignment(ctx, query, nodes,
			func(n *Tag) { n.Edges.TagAssignment = []*TagAssignment{} },
			func(n *Tag, e *TagAssignment) { n.Edges.TagAssignment = append(n.Edges.TagAssignment, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TagQuery) loadSpace(ctx context.Context, query *SpaceQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Space)) error {
...
func (tq *TagQuery) loadChildren(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tag.FieldGroupID)
	}
...
func (tq *TagQuery) loadGroup(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Tag)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (tq *TagQuery) loadSuperTags(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.SuperTagsTable)
		s.Join(joinT).On(s.C(tag.FieldID), joinT.C(tag.SuperTagsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(tag.SuperTagsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.SuperTagsPrimaryKey[1]))
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "super_tags" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (tq *TagQuery) loadSubTags(ctx context.Context, query *TagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Tag)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Tag)
	nids := make(map[int64]map[*Tag]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.SubTagsTable)
		s.Join(joinT).On(s.C(tag.FieldID), joinT.C(tag.SubTagsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(tag.SubTagsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.SubTagsPrimaryKey[0]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "sub_tags" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (tq *TagQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *File)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*Tag)
	nids := make(map[int64]map[*Tag]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.FilesTable)
		s.Join(joinT).On(s.C(file.FieldID), joinT.C(tag.FilesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(tag.FilesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.FilesPrimaryKey[1]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (tq *TagQuery) loadTagAssignment(ctx context.Context, query *TagAssignmentQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *TagAssignment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Tag)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tagassignment.FieldTagID)
	}
	query.Where(predicate.TagAssignment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tag.TagAssignmentColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TagQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := tq.ctx.Fields; len(fields) > 0 {
		...
		if tq.withSpace != nil {
			_spec.Node.AddColumnOnce(tag.FieldSpaceID)
		}
		if tq.withGroup != nil {
			_spec.Node.AddColumnOnce(tag.FieldGroupID)
		}
	}
