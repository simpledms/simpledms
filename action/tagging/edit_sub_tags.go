...
func (qq *EditSubTags) Data(tagID int64, onlyAssigned bool) *EditSubTagsData {
	return &EditSubTagsData{
		TagID:        tagID,
		OnlyAssigned: onlyAssigned,
	}
}

func (qq *EditSubTags) Handler(rw httpx.ResponseWriter, req *httpx.Request, ctx ctxx.Context) error {
	data, err := autil.FormData[EditSubTagsData](rw, req, ctx)
	if err != nil {
		return err
	}
...
func (qq *EditSubTags) assignableListItems(
	ctx ctxx.Context,
...
func (qq *EditSubTags) isCheckedFn(
	ctx ctxx.Context,
	superTag *enttenant.Tag,
...
func (qq *EditSubTags) listItem(
	...
	if isCheckedFn(subTagWithChildren.ID) {
		hxPost = qq.actions.SubTags.UnassignSubTag.Endpoint()
		hxVals = util.JSON(qq.actions.SubTags.UnassignSubTag.Data(superTag.ID, subTagWithChildren.ID))
	} else {
		hxPost = qq.actions.SubTags.AssignSubTag.Endpoint()
		hxVals = util.JSON(qq.actions.SubTags.AssignSubTag.Data(superTag.ID, subTagWithChildren.ID))
	}
...
func (qq *EditSubTags) listItemID(superTagID, subTag int64) string {
	return fmt.Sprintf(
