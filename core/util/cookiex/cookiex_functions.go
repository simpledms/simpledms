...
func SetSessionCookie(rw httpx2.ResponseWriter, req *httpx2.Request, isTemporarySession, allowInsecureCookies bool) (*http.Cookie, error) {
...
func InvalidateSessionCookie(rw httpx2.ResponseWriter, allowInsecureCookie bool) {
	secure := true
