...
func (qq *FileListItem) Data(currentDirID, fileID string) *FileListItemData {
...
// TODO type data?
//
// Deprecated: use DirectoryListItem or FileListItem directly
...
func (qq *FileListItem) DirectoryListItem(
	ctx ctxx.Context,
	currentDirID string,
...
func (qq *FileListItem) supportingTextDirectory(fileWithChildren *enttenant.File, supportingText string) string {
...
func (qq *FileListItem) fileListItem(
	ctx ctxx.Context,
	currentDirID string,
	fileWithChildren *enttenant.File,
	parentFullPath string, // only necessary with breadcrumbs
...
func (qq *FileListItem) supportingTextFile(ctx ctxx.Context, filexx *model.File, supportingText string) string {
